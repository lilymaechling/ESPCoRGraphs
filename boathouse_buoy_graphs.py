...
def draw_graph_depth_temp(csv, date, start, stop, trange, depth, temp):
    ...
    fig.savefig("UpDownBuoyTempDepth.png")  # saves the graph image
...
def do_four_graphs(csv_filename, date, start, stop, range, depth, temp, chloro, conduct, odopercent, odomgl, turb, echodown):
...
# do_four_graphs("May_17_2020/5_17_data.csv", "5/17/20", 312, 706, 395, 22, 36, 20, 21, 24, 26, 32)
# do_four_graphs("April_5_2020/4_5_data.csv", "4/5/20", 114, 312, 199, 22, 36, 20, 21, 24, 26, 32, True)
# do_four_graphs("April_11_2020/4_11_data.csv", "4/11/20", 843, 1222, 380, 22, 36, 20, 21, 24, 26, 32)
# do_four_graphs("April_19_2020/4_19_data.csv", "4/19/20", 766, 1141, 376, 22, 36, 20, 21, 24, 26, 32)
# do_four_graphs("April_25_2020/4_25_data.csv", "4/25/20", 497, 866, 370, 22, 36, 20, 21, 24, 26, 32)
# do_four_graphs("March_26_2020/3_26_data.csv", "3/26/20", 156, 323, 168, 22, 36, 20, 21, 24, 26, 32)
# do_four_graphs("March_26_2020/3_26_data.csv", "3/26/20", 3654, 4006, 353, 22, 36, 20, 21, 24, 26, 32)
